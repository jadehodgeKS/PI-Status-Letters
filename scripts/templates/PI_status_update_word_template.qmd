...
This organization has registered intent with KDHE to submit data in the Promoting Interoperability program (formerly Meaningful Use). The provider's status in select public health registries as of **`r format(Sys.Date(), "%B %d, %Y")`** is:
